...
Top twitter users that have tweeted more than 50 tweets containing the \#blossom hashtag.
...
blossom2021 %>% 
  ...
  ggplot(aes(reorder(screen_name, n), n)) + geom_col(fill = "skyblue3") + coord_flip() + 
    labs(x = "Screen Name", y = "Tweets", title = "#blossom tweets by user", subtitle = "users with >= 50 tweets") + 
    theme(axis.text = element_text(size = 12), axis.title = element_text(size = 12))
```
